...
public class SingleNotificationService extends Service {
    ...
    public void onCreate() {
        Log.d(TAG, "SingleNotificationService - onCreate");
        super.onCreate();
    ...
    private Notification getNotification() {
        Log.d(TAG, "SingleNotificationService getNotification time stamp : " + App.getTimestamp());
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d(TAG, "SingleNotificationService onStartCommand");
